var CONFIG = {
  ...
  OWNER_PERMISSION_VALUE_TOOLTIP: [{v: 'PERMISSION_VALUE_1', t : '上传，下载，预览， 分享（包括邀请协作人和链接分享），编辑（包括编辑文档，更改协作人的权限，以及将协作人从文件夹中移除），删除文档'},
                                   {v: 'PERMISSION_VALUE_2', t : '与拥有者的权限完全相同，除了不能更改拥有者的权限'},
                                   {v: 'PERMISSION_VALUE_3', t : '上传，下载，预览，链接分享'},
                                   {v: 'PERMISSION_VALUE_4', t : '只能上传和预览文件'},
                                   {v: 'PERMISSION_VALUE_5', t : '下载，预览，链接分享'},
                                   {v: 'PERMISSION_VALUE_6', t : '只能预览文件'},
                                   {v: 'PERMISSION_VALUE_7', t : '只能上传文件'}
                                  ],

  //无拥有者权限的value与tooltip
  NOOWNER_PERMISSION_VALUE_TOOLTIP: [{v: 'PERMISSION_VALUE_2', t : '与拥有者的权限完全相同，除了不能更改拥有者的权限'},
                                     {v: 'PERMISSION_VALUE_3', t : '上传，下载，预览，链接分享'},
                                     {v: 'PERMISSION_VALUE_4', t : '只能上传和预览文件'},
                                     {v: 'PERMISSION_VALUE_5', t : '下载，预览，链接分享'},
                                     {v: 'PERMISSION_VALUE_6', t : '只能预览文件'},
